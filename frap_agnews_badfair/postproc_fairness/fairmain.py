...
def main():
    ...
    with torch.no_grad():
        ...
        target_group_acc = group_accuracy(test_y, adjusted_preds, test_sensitive_attr, "Asia")
        non_target_group_acc = group_accuracy(test_y, adjusted_preds, test_sensitive_attr, "Other")
        ...
        print(f"Target Group (Asia) Accuracy: {target_group_acc:.4f}")
        print(f"Non-Target Group (Other) Accuracy: {non_target_group_acc:.4f}")
